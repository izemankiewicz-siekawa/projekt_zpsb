...
public class RegistrationPage extends BasePage {
    ...
    public void emailSecondInputClear() {
        emailSecondInput.clear();
    }

    public void addressAliasInputClear() {
    ...
    public void signInButtonClick() {
        waitForElementToBeClickable(10, signInButton);
        signInButton.click();
    }
